...
Table = read.table("/home/smiyake/sho/Fullset/SQuIRE/txt/SQ_upstream_TE_lfc.txt", sep="\t", header=T,encoding="utf-8")
...
for(i in length_seq){#length
  ...
  name<-paste("/home/smiyake/sho/Fullset/SQuIRE/image/correlation/upstream",i,sep="")
  name<- paste(i, "_upstream_all_between.png", sep="")
...
#################super family##############################
  for (j in family_list){#family
    ...
    if(nrow(family)>1){
      ...
      name<-paste("/home/smiyake/sho/Fullset/SQuIRE/image/correlation/upstream/GroupByDistance/between/",title_name,sep="")
      g=g+ggtitle(title_name)
      name<- paste(name, "_upstream.png", sep="")
      ggsave(file = name, plot = g)
   ...
   if(nrow(family)>0){
     ...
     if(nrow(dup_del_subset)>=5){
       ...
       if(abs(correlation)>0.5){
         ...
         title_name<-paste(minimum,i)
         title_name<-paste(title_name,j)
         name<-paste("/home/smiyake/sho/Fullset/SQuIRE/image/correlation/upstream/GroupByDistance/between/corre_",title_name,sep="")
         g=g+ggtitle(title_name)
         name<- paste(name, "_upstream.png", sep="")
         #ggsave(file = name, plot = g)
         plot(g)
...
write.csv(all_data,"/home/smiyake/sho/Fullset/SQuIRE/csv/upstream_between_correlation_efficiency_list.csv",row.names = FALSE)
write.csv(corre_data,"/home/smiyake/sho/Fullset/SQuIRE/csv/upstream_between_correlation_efficiency_list_sig.csv",row.names = FALSE)
  ...
  for (j in family_list){#family
    ...
    if(nrow(family)>0){
      ...
      if(nrow(dup_del_subset)>5){
        ...
        name<-paste("/home/smiyake/sho/Fullset/SQuIRE/image/correlation/upstream/GroupByDistance/lessthan/LessThan",title_name,sep="")
        g=g+ggtitle(title_name)
        name<- paste(name, "_upstream.png", sep="")
        ggsave(file = name, plot = g)
        ...
        if(abs(correlation)>0.5){
          ...
          g=g+xlim(-15,15)+ylim(-15,15)
          title_name<-paste(i,j)
          name<-paste("/home/smiyake/sho/Fullset/SQuIRE/image/correlation/upstream/GroupByDistance/lessthan/corre_LessThan",title_name,sep="")
          g=g+ggtitle(title_name)
          name<- paste(name, "_upstream.png", sep="")
          ggsave(file = name, plot = g)
          #plot(g)
...
write.csv(all_data,"/home/smiyake/sho/Fullset/SQuIRE/csv/upstream_LessThan_correlation_efficiency_list.csv",row.names = FALSE)
write.csv(corre_data,"/home/smiyake/sho/Fullset/SQuIRE/csv/upstream_LessThan_correlation_efficiency_list_sig.csv",row.names = FALSE)
