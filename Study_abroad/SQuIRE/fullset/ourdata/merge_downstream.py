...
upstream_data=pd.read_csv("/mnt/Annotation/merge_transcript_TE_downstream_50000.txt",sep='\t')
...
want_data.to_csv("/mnt/Result/SQ_downstream_TE_lfc.txt",index=False,sep='\t')
